...
class SchedulerStatus:
    ...
    Attributes:
        ...
        latest_scheduler_heartbeat (Union[None, Unset, str]): The time the scheduler last did a heartbeat.
    """

    status: Union[Unset, HealthStatus] = UNSET
    latest_scheduler_heartbeat: Union[None, Unset, str] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        latest_scheduler_heartbeat: Union[None, Unset, str]
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_latest_scheduler_heartbeat(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
